...
using Petfolio.Application.UseCases.Pets.Resgister;
...
{
    [HttpPost]
    [ProducesResponseType(typeof(ResponseResgisteredPetJson), StatusCodes.Status201Created)]
    [ProducesResponseType(typeof(ResponseErrorsJson), StatusCodes.Status400BadRequest)]
    public IActionResult Register([FromBody] RequestPetJson request)
    {
        //depois de utilizar a regra de negocio ele devolve uma Reposta(Response)
        //business logic
